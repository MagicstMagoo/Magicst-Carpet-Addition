...
import cn.magicst.carpet.util.rule.dispenserCollectXp.GlassBottleDispenserBehavior;
import cn.magicst.carpet.util.rule.dispenserFixIronGolem.IronIngotDispenserBehavior;
import cn.magicst.carpet.util.rule.flippingTotemOfUndying.FlipCooldown;
import cn.magicst.carpet.util.rule.gravestone.GravestoneUtil;
import cn.magicst.carpet.util.rule.potionRecycle.PotionDispenserBehavior;
import cn.magicst.carpet.util.rule.sleepingDuringTheDay.SleepUtil;
...
public class WnaMod implements CarpetExtension, ModInitializer, ClientModInitializer {
    public static final boolean tisCarpetLoaded = FabricLoader.getInstance().isModLoaded("plusls-carpet-additon")
    public static final boolean tisCarpetLoaded = FabricLoader.getInstance().isModLoaded("carpet-tis-addition");
    @Nullable
    public static MinecraftServer server = null;

    static {
        CarpetServer.manageExtension(new WnsMod());
    }
    ...
    public void onGameStarted() {
        ...
        CarpetServer.settingsManager.parseSettingsClass(WnsSettings.class);
